...
TRIPLES = [
    ...
    ("All blog posts", "Bütün Bloq yazıları", "All Blog posts", "Все Блог-записи"),
    ...
    ("Back to blog", "Bloqa qayıt", "Back to Blog", "Назад в Блог"),
    ("Blog", "Bloq", "Blog", "Блог"),
    ("Bloqlar", "Bloqlar", "Blogs", "Блоги"),
    ("Bütün suallar", "Bütün suallar", "All questions", "Все вопросы"),
    ("Blog pagination", "Bloq səhifələməsi", "Blog pagination", "Пагинация Блога"),
    ("Blog post not found", "Bloq yazısı tapılmadı", "Blog post not found", "Блог-запись не найдена"),
    ...
    ("FAQ", "Sual-cavab", "FAQ", "Вопросы и ответы"),
    ...
    ("Hələ heç bir sual əlavə edilməyib.", "Hələ heç bir sual əlavə edilməyib.", "No questions have been added yet.", "Вопросы пока не добавлены."),
    ...
    ("Məhsul və xidmətlərimiz haqqında ən çox verilən sualların cavablarını tapın.", "Məhsul və xidmətlərimiz haqqında ən çox verilən sualların cavablarını tapın.", "Find answers to the most common questions about our products and services.", "Найдите ответы на самые частые вопросы о наших продуктах и услугах."),
    ...
    ("No blog posts yet", "Hələ Bloq yazısı yoxdur", "No Blog posts yet", "Блог-записей пока нет"),
    ...
    ("Tez-tez verilən suallar", "Tez-tez verilən suallar", "Frequently asked questions", "Часто задаваемые вопросы"),
